...
from dbt.events.types import OpenLineageException, CommandCompleted, FoundStats
from dbt.adapters.events.types import SQLQuery
from dbt_common.events.base_types import EventMsg
from dbt.config.project import Project
from dbt.artifacts.resources.types import NodeType

from core.dbt.openlineage.common.utils import get_attribute, get_openlineage_producer, sanitize_job_name_component

GITHUB_LOCATION = "https://github.com/OpenLineage/OpenLineage/tree/main/integration/common/openlineage/schema/"
...
def get_job_name(e: EventMsg, ctx: Context):
    """
