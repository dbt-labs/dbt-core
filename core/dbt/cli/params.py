...
port = click.option(
    "--port",
    envvar=None,
    help="Specify the port number for the docs server. Default is 8080.",
    default=8080,
    type=click.INT,
)
...
# `dbt debug` uses this because it implements custom behavior for non-existent profiles.yml directories
