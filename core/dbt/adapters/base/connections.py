...
class BaseConnectionManager(object):
    ...
    def get_thread_identifier():
        ...
        # TODO: do we need to also mix in the process ID for environments that
        #       fork and then make thread pools (such as the RPC server)? They
        #       should not share a connections dict, right?
        return get_ident()

    def get_thread_connection(self):
        # TODO: is performance a concern here? Need carefully think through how
        #       cancellation should work, we might not even need a lock!
        # TODO: if key not in thread_connections: raise RuntimeError()
        #       when I think I've got connections sorted out
