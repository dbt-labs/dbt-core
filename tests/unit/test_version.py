    ...
    def test_core_behind(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                f"  - foobar: 1.0.0 - {green('Up to date!')}",
                "",
                "Your version of dbt-core is out of date! You can find instructions for upgrading here:",
    ...
    def test_plugins_various(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                f"  - bazqux: 2.1.0    - {yellow('No PYPI version available')}",
                ...
                "  https://docs.getdbt.com/dbt-cli/install/overview",
                "",
                f"  - garply: 2.1.0-b1 - {yellow('No PYPI version available')}",
                "",
                "",
            ]
        )
