    ...
    def test_plugin_diff_core_major_ahead_latest(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                "",
                "Plugins:",
                f"  - foobar: 1.0.0 - {green('Ahead of latest version!')}",
                "",
                "",
            ]
        )
    ...
    def test_plugins_various(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                f"  - bazqux: 2.0.0    - {yellow('No PYPI version available')}",
                f"  - quuux:  1.1.0    - {green('Up to date!')}",
                f"  - corge:  22.21.20 - {red('Not compatible!')}",
                "  Your version of dbt-corge is not compatible with core!",
                "  You can find instructions for upgrading here:",
                "  https://docs.getdbt.com/dbt-cli/install/overview",
                "",
                f"  - grault: 1.1.0    - {yellow('Update available!')}",
                "  Your version of dbt-grault is out of date! You can find instructions for upgrading here:",
                "  https://docs.getdbt.com/dbt-cli/install/overview",
                "",
                f"  - garply: 2.1.0    - {yellow('No PYPI version available')}",
                "",
                "",
            ]
        )
    ...
    def test_plugins_alignment(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                "",
                "Plugins:",
                f"  - foobar: 10.0.0     - {red('Not compatible!')}",
                "  Your version of dbt-foobar is not compatible with core!",
                "  You can find instructions for upgrading here:",
                "  https://docs.getdbt.com/dbt-cli/install/overview",
                "",
                f"  - bazqux: 1.1.1-b123 - {green('Up to date!')}",
                f"  - quuux:  1.0.0      - {yellow('No PYPI version available')}",
                "",
                "",
            ]
        )
    ...
    def test_file_globbing(self, mocker):
        ...
        expected = "\n".join(
            [
                ...
                f"  - quuux:  1.0.0 - {yellow('No PYPI version available')}",
                f"  - corge:  1.0.0 - {yellow('No PYPI version available')}",
                f"  - grault: 1.0.0 - {yellow('No PYPI version available')}",
                f"  - garply: 1.0.0 - {yellow('No PYPI version available')}",
                "",
                "",
            ]
        )
