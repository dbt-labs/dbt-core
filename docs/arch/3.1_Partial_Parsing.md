...
```
saved_files  ∩  new_files  →  check checksums  →  changed / unchanged
saved_files  -  new_files  →  deleted
new_files    -  saved_files  →  added
```
...
- `new_files` — Files read from the current project
