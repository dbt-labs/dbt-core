...
This pattern ensures that the model is never in a partially-built state—readers see either the old version or the new version, never an incomplete table.
