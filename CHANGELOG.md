...
- Adding support for non-master default branch in git ([#3057](https://github.com/fishtown-analytics/dbt/issues/3057))
...
- [@VasiliiSurov](https://github.com/VasiliiSurov) ([#3091](https://github.com/fishtown-analytics/dbt/pull/3091))
