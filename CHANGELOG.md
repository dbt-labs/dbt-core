...
- Add two new flags `--use-colors` and `--no-use-colors` to `dbt run` command to enable or disable log colorization from the command line [#2622](https://github.com/fishtown-analytics/dbt/pull/2622)
...
- [@rsenseman](https://github.com/rsenseman) ([#2622](https://github.com/fishtown-analytics/dbt/pull/2622))
