...
pub struct ProjectSkillConfig {
    ...
    pub __additional_properties__: BTreeMap<String, ShouldBe<ProjectSkillConfig>>,
}

impl TypedRecursiveConfig for ProjectSkillConfig {
...
impl From<ProjectSkillConfig> for SkillConfig {
    fn from(config: ProjectSkillConfig) -> Self {
        Self {
...
impl From<SkillConfig> for ProjectSkillConfig {
...
impl ResolvableConfig<SkillConfig> for SkillConfig {
    type Resolved = ResolvedSkillConfig;
    ...
    fn finalize(self) -> ResolvedSkillConfig {
        self.finalize_resolved()
    }

    fn default_to(&mut self, parent: &SkillConfig) {
